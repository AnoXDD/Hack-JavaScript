...
import {
  ALT_NEW_JOB,
  ALT_NEW_JOB_OKED,
  ALT_NEW_JOB_PLUGIN_REQUEST_FAIL,
  ALT_NEW_JOB_PLUGIN_REQUESTED,
  ANONYMOUS_LATE_EMAIL_FOLLOW_UP,
  INTERNAL_ALT_ACCESSED,
  INTERNAL_ALT_WELCOME,
  INTRODUCTION,
  MANAGER_CONGRATS,
  MANAGER_SPY_COMMENT,
  MEETING_ATTENDED,
  MYSTERIOUS_ACCOUNT_SUBMITTED,
  NEW_TASK_SURVEILLANCE_COMPLETED,
  PASSWORD_RESET_SUCCESS,
  PLAYER_FOUND_UNDER_SURVEILLANCE,
  PROMOTION_ACCEPTED,
  PROMOTION_RECEIVED,
  RESIGNATION_BOOKED,
  RESIGNATION_CANCELED_LOGGED_OUT,
  SPAM_PASSWORD,
  SPY_FIRST_EMAIL,
  SURVEILLANCE_SYSTEM_DISABLED_ALL,
  SURVEILLANCE_SYSTEM_DISABLED_SPY,
